Kendi ozel tasarım yuzuk modellerini satan bir e ticaret sitesi tasarladım.veri tabanından resim cekerken olusan kasılmalar nedemıyle resim kısmını bos bıraktım.
Asagıdaki bolumlere uygun bir web stesi tasarladım.
...
NOT: Projeye yararlı olacak genel sınıf ve metotlar bu katman içerisinde saklanır. Utility library Dal içerisine eklenmeli.
...
7.2.1)Admin template için bootstrap admin panelini kullandık. Daha önce hazırlamış olduğumuz şablonu kendi _layout sayfamıza kopyaladık ve eski projedeki content klasörünü de projemize sürükleyip bıraktık.
7.3)Controllerlar açılarak viewler oluşturulur.
7.4) Attribute klasörü açarak rol bazlı auth işlemleri gerçekleştirebiliriz.